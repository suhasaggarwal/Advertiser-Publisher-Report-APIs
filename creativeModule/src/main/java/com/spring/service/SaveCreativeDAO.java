...
public class SaveCreativeDAO {
   ...
   public static String saveFacebookCreative(String title,String description,String channel, String emailid, String type,Integer size,String dateadded,String status,String NewsFeedTitle,String NewsFeedCreativeFile,String RHSTitle, String RHSMiniDescription, String RHSDescription, String RHSUploadCreativeFile, String MobileSizeUploadTitle, String MobileSizeUploadCreativeFile, String UploadVideoSlideShowFile , String UploadVideoFile, String facebookCreative){
    ...
    query = "INSERT INTO FacebookCreative(Title,Description,Channel,EmailId,Type,Size,Dateadded,Status,NewsFeedTitle,NewsFeedCreativeFile,RHSTitle,RHSMiniDescription,RHSDescription,RHSUploadCreativeFile,MobileSizeUploadTitle,MobileSizeUploadCreativeFile,UploadVideoSlideShowFile,UploadVideoFile,FacebookCreative) VALUES("+"'"+title+"'"+","+"'"+description+"'"+","+"'"+channel+"'"+","+"'"+emailid+"'"+","+"'"+type+"'"+","+"'"+size+"'"+","+"'"+dateadded+"'"+","+"'"+status+"'"+","+"'"+NewsFeedTitle+"'"+","+"'"+NewsFeedCreativeFile+"'"+","+"'"+RHSTitle+"'"+","+"'"+RHSMiniDescription+"'"+","+"'"+RHSDescription + "'"+","+"'"+ RHSUploadCreativeFile + "'"+","+"'"+ MobileSizeUploadTitle + "'"+","+"'"+ MobileSizeUploadCreativeFile + "'"+","+"'"+ UploadVideoSlideShowFile + "'"+","+"'"+ UploadVideoFile+"'"+","+"'"+facebookCreative+"'"+")";
  ...
  return status1;
   ...
   public static String saveWhatsappCreative(String title,String description,String channel, String emailid, String type,Integer size,String dateadded,String status, String WhatsAppAdText, String WhatsAppAdImageUrl, String WhatsAppAdVideoUrl){
        ...
        query1 = "INSERT INTO RestCreative(Title,Description,Channel,EmailId,Type,Size,DateAdded,Status,WhatsAppAdText,WhatsAppAdImageFile,WhatsAppAdVideoFile) VALUES("+"'"+title+"'"+","+"'"+description+"'"+","+"'"+channel+"'"+","+"'"+emailid+"'"+","+"'"+type+"'"+","+"'"+size+"'"+","+"'"+dateadded+"'"+","+"'"+status +"'"+","+"'"+WhatsAppAdText+"'"+","+"'"+WhatsAppAdImageUrl + "'"+","+"'"+WhatsAppAdVideoUrl+"'"+")";
...
return status1;
   ...
   public static String saveSMSCreative(String title,String description,String channel, String emailid, String type,Integer size,String dateadded,String status, String SMSText){
	    String ServerConnectionURL = "jdbc:mysql://52.90.244.81:3306/cuberootapp";
		String DBUser = "root";
	    String DBPass = "Qwerty12@";
	    String DBName = "cuberootapp";
       ...
       query1 = "INSERT INTO RestCreative(Title,Description,Channel,EmailId,Type,Size,DateAdded,Status,SMSText) VALUES('"+title+"'"+","+"'"+description+"'"+","+"'"+channel+"'"+","+"'"+emailid+"'"+","+"'"+type+"'"+","+"'"+size+"'"+","+"'"+dateadded+"'"+","+"'"+status +"'"+","+"'"+SMSText+"'"+")";
