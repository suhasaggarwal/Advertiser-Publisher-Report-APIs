...
public class AddChannelCampaignDAO {
...
/*     query1 = "INSERT INTO Campaign(CampaignName,ObjectiveId,StartDate,EndDate,Status,Approval,Email) VALUES("+"'"+campName+"'"+","+"'"+ObjectiveId+"'"+","+"'"+startDate+"'"+","+"'"+endDate+"'"+","+"'"+status+"'"+","+"'"+Approval+"'"+","+"'"+Email+"'"+")";
	...
	*/ 	      
	     ...
	     query4 = "INSERT INTO TargetCampaign(TargetType,Lookalike,InterestSegmentId,GeographyId,AgeRange,Gender,IncomeRange) VALUES("+"'"+TargetType+"'"+","+"'"+Lookalike+"'"+","+"'"+interestsegmentid+"'"+","+"'"+geographyid+"'"+","+"'"+agerangeid+"'"+","+"'"+gender+"'"+","+"'"+incomelevel+"'"+")";
...
*/		 
		 query9 = "INSERT INTO CampaignChannel(CampaignId,CreativeId,ChannelId,Status,EmailId,BudgetCampaignChannelId,TargetCampaignChannelId) VALUES("+"'"+campId+"'"+","+"'"+creativeid+"'"+","+"'"+channelId+"'"+","+"'"+status+"'"+","+"'"+Email+"'"+","+"'"+lastid+"'"+","+"'"+lastid1+"' )";
