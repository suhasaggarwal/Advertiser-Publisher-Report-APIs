	...
	public SaveCreativeResponse submit(@RequestBody Creative creative,
		...
		if (creative.getChannel().equals("Facebook")) {
			...
			status = SaveCreativeDAO.saveFacebookCreative(creative.getTitle(),
					...
					creative.getNewsFeedCreativeUrl(), creative.getRHSTitle(),
					creative.getRHSMiniDescription(),
					creative.getRHSDescription(),
					creative.getRHSUploadCreativeUrl(),
					creative.getMobileSizeUploadTitle(),
					creative.getMobileSizeUploadCreativeUrl(),
					creative.getUploadVideoSlideShowUrl(),
					creative.getUploadVideoUrl());
...

		{
			...
			status = SaveCreativeDAO.saveEmailCreative(creative.getTitle(),
					...
					creative.getEmailMrktUploadUrl());
