...
//There are report codes for each report type - Url structure takes reportid, date range, campaign_id as parameters in case no campaign id is given, all campaign data corresponding to advertiser is picked
