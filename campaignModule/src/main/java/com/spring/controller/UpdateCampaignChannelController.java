...
import com.spring.service.EditCampaignChannelDAO;
import com.spring.service.UpdateCampDAO;
import com.spring.util.EncryptionModule;

@RestController
public class UpdateCampaignChannelController {

	@RequestMapping(value = "/updatecampaigndetailschannel", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public UpdateCampaignResponse updateCampaignChannelDetails(@RequestBody ChannelCampaign campaign,HttpServletRequest request) {
...
//		 List<DisplayCampaign> campaign  = new ArrayList<DisplayCampaign>();
 	    ...
 	    if(emailId != null)
 	    status= EditCampaignChannelDAO.updateCampaignChannel(campaign, emailId);
